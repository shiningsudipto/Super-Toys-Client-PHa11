                ...
                <label className="modal-box relative" htmlFor="">
                    ...
                    <form onSubmit={handleToyUpdate}>
                        <div className="form-control">
                            ...
                            <input name='price' required type="number" placeholder="Price" className="input input-bordered" />
                        </div>
                        <div className="form-control">
                            <label className="label">
                                <span className="label-text">Available quantity:</span>
                            </label>
                            <input type="number" required name='quantity' placeholder="Available quantity" className="input input-bordered" />
                        </div>
                        <div className="form-control">
                            <label className="label">
